...
shop.description = "tutorial shop description" //todo
...
let enemy2 = new Enemy(20, "", [new Dice(DICE.d4), new Dice(DICE.d6)], [new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d6), new Dice(DICE.d6), new Dice(DICE.d8), new Dice(DICE.d8)]);
...
let tutorialDialogue = new DialogueEvent([{text : "Nah", slots : 0, effect : {succes: (n: number)=>{return {succes: true, text : "You move on."}}, rewards: []}}
...
let equipmentDialogue = new DialogueEvent([{text : "Nah", slots : 0, effect : {succes: (n: number)=>{return {succes: true, text : "You move on."}}, rewards: []}}
	,{text : "Search, roll higher than 5 to succeed", slots : 2, effect : {succes: (n: number)=>{return n>=5?{succes : true, text : "You found some dice!"}:{succes : false, text : "You didn't find anything."}}, rewards: [new Dice(DICE.d6), new Dice(DICE.d4)]}}]
	, "You found an equipment!");
