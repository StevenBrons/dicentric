...
//construct boss
let boss = new Enemy(25, "boss", [new Dice(DICE.d4), new Dice(DICE.d6), new Dice(DICE.d8)], [new OnlyEven()], "Congratulations! You defeated the boss and completed the tutorial level. You got a new equipment!");

//construct battles
let battle1 = constructBirdEvent().event;
let battle2 = constructCubeEvent().event;
...
let tutorialDialogue = new DialogueEvent([{text : "Search thoroughly, roll higher than 4 to succeed", slots : 2, effect : {succes: (n: number)=>{return n>4?{succes : true, text : "You found some dice! \n (d4 x 3, d6 x 2)"}:{succes : false, text : "You didn't find anything."}}, rewards: [new Dice(DICE.d6), new Dice(DICE.d6), new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d4)]}}
	, {text : "Search for a bit, roll higher than 2 to succed", slots : 1, effect : {succes: (n: number)=>{return n>2?{succes : true, text : "You found some dice! \n (d4 x 2, d6 x 1)"}:{succes : false, text : "You didn't find anything."}}, rewards: [new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d6)]}}]
...
let junctionDialogue = new DialogueEvent([]
	, "There are some enemies up ahead. The creature up looks stronger than down. Maybe it has a higher reward though?");
...
let level1 = new Level(1, map, 
	[new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d4), new Dice(DICE.d6), new Dice(DICE.d6), new Dice(DICE.d6), new Dice(DICE.d8), new Dice(DICE.d8), new Dice(DICE.d8), new Dice(DICE.d10), ]
);
