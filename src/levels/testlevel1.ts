...
//construct map
let node4 = new MapNode([], 10, 5, 2, null, false,"");
let node3 = new MapNode([node4], 5, 10, 1, null, false,"");
let node2 = new MapNode([node4], 5, 0, 1, null, false,"");
let node1 = new MapNode([node2, node3], 0, 5, 0, null, false,"");
let map = new MapState([node1,node2,node3,node4], [shop1, shop2], "", {width:640, height:180}); 
